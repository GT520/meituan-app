<template>
  <div class="header">
    ...
    <div class="content-wrapper">
      ...
      <div class="collect" @click="favoriteFn">
        <div class="icon-star" :class="{active:favorite}"><img src="./img/star1.png"/></div>
...
<style scoped>
  ...
  .header .content-wrapper .collect .icon-star {
    line-height: 24px;
    margin-bottom: 4px;
  }
  ...
  .header .content-wrapper .collect:active  .text{
    color: red;
  }
